...
DIR=r"C:\Users\zaina\OneDrive\Desktop\colour"
PROTOTXT=os.path.join(DIR,r"COLOURIZATION\colorization_deploy_v2.prototxt")
POINTS=os.path.join(DIR,r"COLOURIZATION\pts_in_hull.npy")
MODEL=os.path.join(DIR,r"COLOURIZATION\colorization_release_v2.caffemodel")
